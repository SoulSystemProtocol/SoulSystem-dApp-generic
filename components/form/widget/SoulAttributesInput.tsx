        ...
        <Grid key={1} item xs={12} md={6}>
          ...
          <Stack spacing={2}>
            <TextField
              ...
              value={getAttribute(attributes, PROFILE_TRAIT_TYPE.firstName)}
              required
            />
            <TextField
              variant="outlined"
              ...
              disabled={props.disabled}
              value={getAttribute(attributes, PROFILE_TRAIT_TYPE.lastName)}
              required
            />
            <TextField
              variant="outlined"
            ...
            <TextField
              ...
              disabled={props.disabled}
              value={getAttribute(attributes, PROFILE_TRAIT_TYPE.description)}
              multiline
              rows={4}
            />
          </Stack>
