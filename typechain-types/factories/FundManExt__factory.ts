...
import type { FundManExt, FundManExtInterface } from "../FundManExt";
...
export class FundManExt__factory extends ContractFactory {
  ...
  attach(address: string): FundManExt {
    return super.attach(address) as FundManExt;
  }
  connect(signer: Signer): FundManExt__factory {
    return super.connect(signer) as FundManExt__factory;
  }
  static readonly contractName: "FundManExt";
  public readonly contractName: "FundManExt";
