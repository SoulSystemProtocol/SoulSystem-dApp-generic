...
export interface ProtocolEntityInterface extends utils.Interface {
  contractName: "ProtocolEntity";
  functions: {
...
export interface ProtocolEntity extends BaseContract {
  contractName: "ProtocolEntity";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProtocolEntityInterface;
