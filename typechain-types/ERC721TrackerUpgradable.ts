...
export interface ERC721TrackerUpgradableInterface extends utils.Interface {
  contractName: "ERC721TrackerUpgradable";
  functions: {
...
export type TransferByTokenEvent = TypedEvent<
  ...
  { fromSBT: BigNumber; toSBT: BigNumber; id: BigNumber }
>;
...
export interface ERC721TrackerUpgradable extends BaseContract {
  contractName: "ERC721TrackerUpgradable";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721TrackerUpgradableInterface;
  ...
  filters: {
    ...
    "TransferByToken(uint256,uint256,uint256)"(
      fromSBT?: BigNumberish | null,
      toSBT?: BigNumberish | null,
