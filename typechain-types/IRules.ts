...
export interface IRulesInterface extends utils.Interface {
  contractName: "IRules";
  functions: {
...
export type ConfirmationEvent = TypedEvent<
  ...
  { id: BigNumber; ruling: string; evidence: boolean; witness: BigNumber }
>;
...
export type RuleEffectEvent = TypedEvent<
  ...
  { id: BigNumber; domain: string; value: BigNumber }
>;

export type RuleEffectEventFilter = TypedEventFilter<RuleEffectEvent>;

export type RuleRemovedEvent = TypedEvent<[BigNumber], { id: BigNumber }>;
...
export interface IRules extends BaseContract {
  ...
  filters: {
    ...
    Claim(id?: BigNumberish | null, claimId?: null): ClaimEventFilter;
    ...
    "RuleRemoved(uint256)"(id?: BigNumberish | null): RuleRemovedEventFilter;
    RuleRemoved(id?: BigNumberish | null): RuleRemovedEventFilter;
  };
