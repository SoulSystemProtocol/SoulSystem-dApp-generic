...
export interface VotesRepoTrackerUpIntInterface extends utils.Interface {
  contractName: "VotesRepoTrackerUpInt";
  functions: {
  ...
  events: {
    ...
    "DelegateVotesChanged(address,int256,int256)": EventFragment;
...
export interface VotesRepoTrackerUpInt extends BaseContract {
  contractName: "VotesRepoTrackerUpInt";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VotesRepoTrackerUpIntInterface;
  ...
  filters: {
    ...
    "DelegateVotesChanged(address,int256,int256)"(
