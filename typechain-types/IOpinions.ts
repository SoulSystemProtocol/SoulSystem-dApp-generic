...
export interface IOpinionsInterface extends utils.Interface {
  contractName: "IOpinions";
  functions: {
...
export interface IOpinions extends BaseContract {
  contractName: "IOpinions";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOpinionsInterface;
